 ...
 * @method \Flagbit\Hubspot\Resources\Companies              companies()
...
class Factory
{
    ...
    public function __call(string $name, $args): Resource
    {
        ...
        if ($name === 'companies') { // this we need for every extended resource
            $resource = 'Flagbit\\Hubspot\\Resources\\'.ucfirst($name);
        }
     ...
     * @return static
     */
    public static function createWithOAuth2Token(
        string $token,
        Client $client = null,
        array $clientOptions = [],
        bool $wrapResponse = true
